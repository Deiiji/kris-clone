...
void LLView::drawChildren()
{
	if (!mChildList.empty())
	{
		static const LLRect rootRect = getRootView()->getRect();
		// KL NO NO NO ....... does NO ONE actually Check this SHIT! try clicking group roles... watch your interface dissapear!
	 	// DO not merge the !Parentview 
