...
void LLBottomTray::initResizeStateContainers()
{
	...
	mStateProcessedObjectMap.insert(std::make_pair(RS_BUTTON_SIDEBAR, getChild<LLPanel>("sidebar_btn_panel"))); //S21
	...
	mStateProcessedObjectMap.insert(std::make_pair(RS_BUTTON_INVENTORY, getChild<LLPanel>("inventory_btn_panel"))); // S21
	...
	mButtonsProcessOrder.push_back(RS_BUTTON_SIDEBAR); //S21
    ...
    mButtonsProcessOrder.push_back(RS_BUTTON_INVENTORY); // S21
...
void LLBottomTray::initButtonsVisibility()
{
	...
	setVisibleAndFitWidths(RS_BUTTON_SIDEBAR, gSavedSettings.getBOOL("ShowSidebarButton")); //S21
	...
	setVisibleAndFitWidths(RS_BUTTON_INVENTORY, gSavedSettings.getBOOL("ShowInventoryButton")); // S21
}
...
void LLBottomTray::setButtonsControlsAndListeners()
{
	...
	gSavedSettings.getControl("ShowSidebarButton")->getSignal()->connect(boost::bind(&LLBottomTray::toggleShowButton, RS_BUTTON_SIDEBAR, _2)); // S21
    ...
    gSavedSettings.getControl("ShowInventoryButton")->getSignal()->connect(boost::bind(&LLBottomTray::toggleShowButton, RS_BUTTON_INVENTORY, _2)); // S21
