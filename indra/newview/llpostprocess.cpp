					...
					screenW(1), screenH(1)
{
	...
	if (!mAllEffects.has("default"))
	{
		...
		defaultEffect["enable_anaglyph_vision"] = LLSD::Boolean(false);
		defaultEffect["enable_toon_shader"] = LLSD::Boolean(false);
		...
		/// Anaglyph Defaults
		defaultEffect["offset_t"] = 0.00;
		defaultEffect["offset_s"] = 6.50;
