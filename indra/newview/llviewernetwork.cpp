...
const char* DEFAULT_LOGIN_PAGE = "http://www.kirstensviewer.com/LoginScreen"; // S21
...
const char* DEFAULT_APP_SLURL_BASE = "x-grid-location-info://%s/secondlife"; // not app? KL
