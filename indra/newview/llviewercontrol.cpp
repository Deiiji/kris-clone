...
void settings_setup_listeners()
{
	...
	gSavedSettings.getControl("RenderDeferred")->getSignal()->connect(boost::bind(&handleRenderUseFBOChanged, _2)); // KL this function is identical only the name is diff
